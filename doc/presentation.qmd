...
2. Remove redundant columns (iso codes, empty HIV bounds).

3. Standardize variable names (cdr_pct, rr_incidence, Preventive_Tx).

4. Recode categorical variables (sex, risk factors).

5. Clean strings & metadata (age formatting, survey sources).

6. Identify missingness patterns (Namibia, DPRK, RR gaps).

7. Validate with checks (summaries, year structure).

8. Save cleaned datasets (burden, age/sex, LTBI, MDR/RR).
