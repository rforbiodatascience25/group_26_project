...
## Introduction {.smaller-subtitle}

### Epidemiological datasets (WHO 2024–2025) {.subtitle}
:::{.large}
...
![](../results/images/06_sexdistribution_scatterplot.png){width="2000"} 
:::
:::::
...
![](../results/images/06_age_distribution.png){width="2000"}
:::
::: {.column width="50%" style="font-size: 0.9em"}

```{r 6_2, echo=TRUE, eval=FALSE}
TB_age_sex |>
  group_by(age_group) |>
...
![](../results/images/06_age_distribution_burden.png){width="2000"} 
:::
:::::
...
![](../results/images/05_evolution_tb_incidence.png){width="1500"}
:::
...
![](../results/images/05_evolution_TPT.png){width="1500"}
:::
:::::
