...
save_data(LTBI_est_df, "01_load_LTBI_estimates.tsv")
...
save_data(TB_age_sex_df, "01_load_TB_age_sex.tsv")
...
save_data(MDR_RR_est_df, "01_load_MDR_RR_burden_estimates.tsv")
...
save_data(TB_countries_df, "01_load_TB_burden.tsv")
...
save_data(TB_dict, "01_load_dictionary.tsv")
