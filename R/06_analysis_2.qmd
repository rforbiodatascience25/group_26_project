...
E.g. since the 'undernourishment' label is only present in data which only has 'age=all' (goes into the 'mixed age' group), then this will prevent us from intepreting anything on a broader level.
