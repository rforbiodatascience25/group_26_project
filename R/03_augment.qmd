...
data_file   <- "02_clean_TB_age_sex.tsv"
...
data_file     <- "02_clean_MDR_RR_burden_estimates.tsv"
...
data_file   <- "02_clean_LTBI_estimates.tsv"
...
```{r}
save_data(TB_age_sex, "03_aug_TB_age_sex.tsv")
```
...
```{r}
save_data(TB_10_years, "03_aug_TB_10_years.tsv")
```
