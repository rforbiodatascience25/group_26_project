...
TB_age_sex <- TB_age_sex |>
  ...
  ungroup() |>
  mutate(TB_cases_pr_100k_best = total_TB_cases_best/10^5,
         TB_cases_pr_100k_min = total_TB_cases_min/10^5, 
         TB_cases_pr_100k_max = total_TB_cases_max/10^5)
...
TB_age_sex |>
  group_by(country) |>
  summarise(average = mean(TB_cases_pr_100k_best, na.rm = TRUE)) |>
